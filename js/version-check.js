...
async function checkForUpdates() {
    try {
        ...
        let latestVersion;
        const VERSION_URL = {
            PROXY: 'https://ghfast.top/raw.githubusercontent.com/funnychip796/LibreTV/main/VERSION.txt',
            DIRECT: 'https://raw.githubusercontent.com/funnychip796/LibreTV/main/VERSION.txt'
        };
            ...
            setTimeout(() => {
                ...
                if (updateBtn) {
                    updateBtn.addEventListener('click', () => {
                        window.open('https://github.com/funnychip796/LibreTV', '_blank');
                    });
                }
            }, 100);
        } else {
